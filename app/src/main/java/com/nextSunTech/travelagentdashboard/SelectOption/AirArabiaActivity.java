...
import com.nextSunTech.travelagentdashboard.AirlinePNRActivities.AirArabiaPNRActivity;
import com.nextSunTech.travelagentdashboard.R;

import java.util.Objects;

public class AirArabiaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_arabia);

        radioGroup = findViewById(R.id.radiogroup);
        hybridRB = findViewById(R.id.rb_airArabia_pnr);
        manualRB = findViewById(R.id.rb_airArabia_ticketDetail);
        continueBT = findViewById(R.id.bt_selectOption);
        backBT = findViewById(R.id.iv_airArabia_back);
    ...
    private void SelectOption() {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.rb_airArabia_pnr:
                Intent intent = new Intent(this, AirArabiaPNRActivity.class);
                startActivity(intent);
                Toast.makeText(this, "Enter your PNR", Toast.LENGTH_SHORT).show();
                finish();
                break;

            case R.id.rb_airArabia_ticketDetail:
