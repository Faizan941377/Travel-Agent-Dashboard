...
import com.nextSunTech.travelagentdashboard.AirlinePNRActivities.OmanAirPNRActivity;
import com.nextSunTech.travelagentdashboard.R;

import java.util.Objects;

public class OmanAirActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oman_air);

        radioGroup = findViewById(R.id.radiogroup);
        hybridRB = findViewById(R.id.rb_oman_pnr);
        manualRB = findViewById(R.id.rb_oman_ticketDetail);
        continueBT = findViewById(R.id.bt_selectOption);
        backBT = findViewById(R.id.iv_omanAir_back);
    ...
    private void SelectOption() {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.rb_oman_pnr:
                Intent intent = new Intent(this, OmanAirPNRActivity.class);
                startActivity(intent);
                Toast.makeText(this, "Enter your PNR", Toast.LENGTH_SHORT).show();
                finish();
                break;

            case R.id.rb_oman_ticketDetail:
