...
import com.nextSunTech.travelagentdashboard.AirlinePNRActivities.KuwaitPNRActivity;
...
public class KuwaitActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hybridRB = findViewById(R.id.rb_kuwait_pnr);
        manualRB = findViewById(R.id.rb_kuwait_ticketDetail);
        continueBT = findViewById(R.id.bt_selectOption);
        backBT = findViewById(R.id.iv_kuwait_back);
    ...
    private void SelectOption() {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.rb_kuwait_pnr:
                Intent intent = new Intent(this, KuwaitPNRActivity.class);
                startActivity(intent);
                Toast.makeText(this, "Enter your PNR", Toast.LENGTH_SHORT).show();
                finish();
                break;

            case R.id.rb_kuwait_ticketDetail:
