...
import com.nextSunTech.travelagentdashboard.AirlinePNRActivities.SaudiAirlinePNRActivity;
import com.nextSunTech.travelagentdashboard.R;

import java.util.Objects;

public class SaudiAirelineActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saudi_aireline);

        radioGroup = findViewById(R.id.radiogroup);
        hybridRB = findViewById(R.id.rb_saudi_pnr);
        manualRB = findViewById(R.id.rb_saudi_ticketDetail);
        continueBT = findViewById(R.id.bt_selectOption);
        backBT = findViewById(R.id.iv_saudi_back);
    ...
    private void SelectOption() {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.rb_saudi_pnr:
                Intent intent = new Intent(this, SaudiAirlinePNRActivity.class);
                startActivity(intent);
                Toast.makeText(this, "Enter your PNR", Toast.LENGTH_SHORT).show();
                finish();
                break;

            case R.id.rb_saudi_ticketDetail:
